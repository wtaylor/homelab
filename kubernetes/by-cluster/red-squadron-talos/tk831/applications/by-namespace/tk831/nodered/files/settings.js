...
const kanidmIssuer = new Issuer({
  issuer: "https://auth.w7x6t.dev/oauth2/openid/nodered",
  authorization_endpoint: "https://auth.w7x6t.dev/ui/oauth2",
  token_endpoint: "https://auth.w7x6t.dev/oauth2/token",
  userinfo_endpoint: "https://auth.w7x6t.dev/oauth2/openid/nodered/userinfo",
  jwks_uri: "https://auth.w7x6t.dev/oauth2/openid/nodered/public_key.jwk",
  revocation_endpoint: "https://auth.w7x6t.dev/oauth2/token/revoke",
  introspection_endpoint: "https://auth.w7x6t.dev/oauth2/token/introspect",
...
const oidcClient = new kanidmIssuer.Client({
  client_id: process.env.OAUTH_CLIENT_ID,
  client_secret: process.env.OAUTH_CLIENT_SECRET,
  redirect_uris: ["https://nodered.tk831.net/auth/strategy/callback"],
  response_types: ["code"],
    ...
    strategy: {
      ...
      options: {
        ...
        verify: function (tokenset, userinfo, done) {
          ...
          console.log("[oidc] verify -> username:", user.username);
          done(null, user);
        },
      },
    },
    users: [{ username: "wtaylor", permissions: ["*"] }],
  },
